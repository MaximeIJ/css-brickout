    ...
    ballConfigs: [
      {
        ...
        x: 75,
        y: 46,
        movement: {...ballBase.movement, angle: (5 * ng) / 4},
      },
      {
        ...ballBase,
        x: 75,
        y: 46,
        movement: {...ballBase.movement, angle: (5.02 * ng) / 4},
      },
      {
        ...ballBase,
        x: 75,
        y: 46,
        movement: {...ballBase.movement, angle: (5.05 * ng) / 4},
      },
      {
        ...ballBase,
        x: 75,
        y: 46,
        movement: {...ballBase.movement, angle: (5.08 * ng) / 4},
      },
    ],
    levelConfig: {
      layout: [
